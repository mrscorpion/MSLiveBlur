...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        _initialBlurLevel = kMSBlurredBackgroundDefaultLevel;
        _initialGlassLevel = kMSBlurredBackgroundDefaultGlassLevel;
        _glassColor = kMSBlurredBackgroundDefaultGlassColor;
        ...
        _backgroundGlassView.backgroundColor = kMSBlurredBackgroundDefaultGlassColor;
...
{
//    NSLog(@"blurLever --> %f", blurLevel); // 0.0 ~ 33.0
